...
function App() {
  ...
  return (<>
    ...
    <Routes>
      ...
      <Route path="/sucesso" element={<Sucess session={session} nome={nome} setNome={setNome} cpf={cpf} setCpf={setCpf} chosenSeats={chosenSeats} setChosenSeats={setChosenSeats} seatsId={seatsId} itens={itens} setSeatsId={setSeatsId} />} />
    </Routes>
    </AppSize>
    </BrowserRouter>
    </>
